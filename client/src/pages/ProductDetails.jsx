...
const ProductDetails = () => {
 ...
 {relatedProducts.filter((product)=>product.inStock).map((product, index) => (
    <ProductCard key={index} product={product}/>
                ...
                <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className='mx-auto cursor-pointer px-12 mt-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition'>See more</button>
            </div>
        </div>
    );
};
